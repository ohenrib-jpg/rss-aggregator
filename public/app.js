// public/app.js - VERSION COMPLÈTEMENT CORRIGÉE ET ENRICHIE
...
window.app = (function () {
    ...
    async function testAIConnection() {
        ...
        try {
            // Tester la connexion avec Flask IA
    ...
    function changeLanguage(lang) {
        ...
        // TODO: Implémenter l'internationalisation
...
window.closeModal = window.app.closeModal;// public/app.js - VERSION COMPLÈTEMENT CORRIGÉE ET ENRICHIE
const API_BASE = window.__API_BASE__ || (location.origin.includes('http') ? location.origin : 'http://localhost:3000');
